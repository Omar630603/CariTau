    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item">
                ...
                <div class="carousel-caption">
                    <h1>Keep Looking</h1>
                    <p>We provide courses that contain materials which has been selected by our team. Navigate many
                        Courses and interact with
                        materials</p>
                </div>
            </div>
            <div class="carousel-item">
                ...
                <div class="carousel-caption">
                    <h1>Keep Fighting</h1>
                    <p>“When one door closes, another opens; but we often look so long and so regretfully upon the
    ...
    <div style="display: flex; flex-wrap: wrap; gap: 40px; justify-content: space-evenly">
        ...
        <div class="card " style="width: 12rem">
            ...
            <div class="card-body d-flex flex-column" style="margin-top: 5px">
                ...
                <span class="mt-auto" data-toggle="collapse" data-target="#major{{$major->ID_major}}"
                    href="#major{{$major->ID_major}}">
                    <a class="mt-auto btn btn-outline-dark" data-toggle="tooltip" role="button"
                        onclick="scrolls({{ $major->ID_major }}); return false" title="Double click to view content"
                        style="width: 100%">Courses</a>
                </span>
            </div>
        </div>
        @endforeach
    ...
    <div class="row" style="margin-left: 0;margin-right: 0;">
        <div class="collapse multi-collapse" id="major{{$major->ID_major}}" style="width: 100%">
            <div class="card-header" style="width: 100%; background:linear-gradient(rgba(0, 0, 0, 0.2),rgba(0, 0, 0, 0.6)), url({{ asset('storage/' . $major->image) }});
                ...
                <center>
                    <h5 class="card-title" style="font-weight: 900;color: white;text-transform: uppercase;">
                        {{ $major->major_name }}</h5>
                </center>
            </div>
            <div class="row" style="margin-left: 0;margin-right: 0">
                <div style="display: flex; flex-wrap: wrap; gap: 50px; justify-content: space-between">
                    ...
                    <div class="card card-course">
                        ...
                        <div class="card-body d-flex flex-column" style="margin-bottom: 5px">
                            ...
                            <a href="{{route('course', $course)}}" style="border-radius:20px;"
                                class="mt-auto btn btn-warning">Access</a>
                            @else
                            <a href="{{route('course', $course)}}" style="border-radius:20px;"
                                class="mt-auto btn btn-outline-success">Enroll</a>
                            @endif
                            @else
                            <a href="{{route('course', $course)}}" style="border-radius:20px;"
                                class="mt-auto btn btn-outline-success">Enroll</a>
                            @endif
                            @else
                            <a href="{{route('redirectLogin')}}" style="border-radius:20px;"
                                class="mt-auto btn btn-success">Learn more</a>
                            @endauth
                        </div>
                    </div>
                    @endif
