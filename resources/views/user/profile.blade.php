        ...
        <div class="row gutters-sm" id="edit" style="display: none">
            <div class="col-md-4 mb-3">
                            ...
                            <div class="mt-3">
                                <div style="display: flex; flex-direction: column; gap: 10px;">
                                    ...
                                    <form method="post" style="display: none;"
                                        action="{{ route('userStudent.updateImage', Auth::user()) }}"
                                    ...
                                    <form style="display: none" method="POST"
                                        action="{{ route('userStudent.restoreImage', Auth::user()) }}" id="restore">
                                        @csrf
                                    </form>
                                </div>
                            </div>
                ...
                <div style="margin-top: 10px;" class="justify-content-center">
                    ...
                    <form id="delete" style="display: none" action="{{ route('userStudent.delete', Auth::user()) }}"
                        method="POST">
                        @csrf
                        @method('DELETE')
                    </form>
            ...
            <div class="col-md-8">
                <div class="card mb-3" style="border-radius:20px;">
                    <form method="post" action="{{ route('userStudent.update', Auth::user()) }}"
                        enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            <div class="float-right" style="cursor: pointer;">
