...
<body>
    <div class="wrapper d-flex align-items-stretch"
        ...
        <nav id="sidebar">
            ...
            <div class="p-4">
                <h1>
                    <a href="{{ route('course', $course) }}" style="text-decoration: none; margin-top:10px" class="logo">{{$course->course_name}}
                        ...
                        @if ($enrollment->status == 1)
                            ...
                            <li class="active">
                                <a href="{{route('material', ['course'=>$course, 'material'=>$m])}}">
                                    ...
                                    {{$m->material_name}}  <span style="font-size: 20px" data-toggle="tooltip" title="Unlocked" class="fa fa-unlock float-right mt-1">
                                </a>
                            </li>
                            @else
                            <li>
                        ...
                        @elseif($enrollment->status == 0)
                            ...
                            @else 
                                ...
                                <li class="active">
                                    <a href="">
                                        <span class="fas fa-book-open mr-3"></span>
                                        {{$m->material_name}} <span style="font-size: 22.5px" data-toggle="tooltip" title="locked" class="fa fa-lock float-right mt-1">
                                    </a>
                                </li>
                                @else
                                <li>
                        ...
                        <div class="card h-100" style="border-radius:20px;">
                            <div class="card-body" style="background: #3ba7ff;border-radius:20px;">
                                <div class="d-flex flex-column align-items-center text-center">
                                    <a href="{{ route('user.profile') }}"><img src="{{ asset('storage/' . Auth::user()->image) }}"
                                ...
                                <div style="display: flex; flex-direction: column; justify-content: space-between; width: 100%">
                                    <div class="container" id="files">
                                        <div class="card">
                                            <div class="card-body d-flex" style="flex-direction: column; justify-content: space-between">
                                                @if(count($files)>0)
                                                <strong style="margin-bottom: 5px; margin-right: 5px; color: #3b4ec6"># Files</strong>
                                                @foreach ($files as $file)
                                                <div class="mt-auto" style="display: flex; gap: 5px; padding-bottom: 5px; flex-wrap: wrap">
                                                    <img style="margin-top: 5px; flex:0" width="30px" height="30px" src="{{ asset('storage/'.$file->icon) }}" alt="">
                                                    @if ($file->file_extension === 'pdf' || $file->file_extension === 'jpeg'||
                                                    $file->file_extension === 'png'|| $file->file_extension === 'jpg')
                                                    <a style="margin-top: 10px; flex:1" href="{{route('user.showFile', $file)}}" target="_blank"
                                                        rel="noopener noreferrer">{{$file->file_title}}</a>
                                                    @else
                                                    <a style="margin-top: 10px; flex:1" href="{{route('user.downloadFiles', $file)}}">{{$file->file_title}}</a>
                                                    @endif
                                                    <a style="margin-right: 5px; margin-top: 15px; flex:0" class="float-right" href="{{route('user.downloadFiles', $file)}}"><i class="fas fa-download"></i></a>
                                                </div>
                                    ...
                                    <div class="container" id="videos">
                                        <div class="card">
                                            <div class="card-body d-flex" style="flex-direction: column; justify-content: space-between">
                                                @if(count($videos)>0)
                                                <strong style="margin-bottom: 5px; margin-right: 5px; color: #3b4ec6"># Videos</strong>
                                                @foreach ($videos as $video)
                                                <div class="mt-auto"style="display: flex; gap: 15px; padding-bottom: 5px; flex-wrap: wrap">
                                                    <img style="margin-top: 5px;" width="30px" height="30px" src="{{ asset('storage/images/video.png') }}" alt="">
                                                    <a style="margin-top: 10px;" href="{{$video->video_url}}" target="_blank" rel="noopener noreferrer">{{$video->video_name}}
                                                    </a>
                                                </div>
                                                <span style="margin-top: 5px;margin-bottom: 5px;border-bottom: 1px solid #ccc;">
                                                    <h6 class="d-flex align-items-center"
                                    ...
                                    <div class="container" id="quiz">
                                        <div class="card">
                                            <div class="card-body d-flex" style="flex-direction: column; justify-content: space-between">
                                                @if(count($quizzes)>0)
                                                <strong style="margin-bottom: 5px; margin-right: 5px; color: #3b4ec6"># Quiz</strong>
                                    ...
                                    <div class="container" id="fourms">
                                        <div class="card">
                                            <div class="card-body d-flex" style="flex-direction: column; justify-content: space-between">
                                                @if(count($forums)>0)
                                                <strong style="margin-bottom: 5px; margin-right: 5px; color: #3b4ec6"># Fourms of Discussion</strong>
                                                @foreach ($forums as $forum)
                                                <div class="mt-auto" style="display: flex; gap: 15px; padding-bottom: 5px; flex-wrap: wrap">
                                                    <img style="margin-top: 5px;" width="30px" height="30px" src="{{ asset('storage/images/forum.png') }}" alt="">
                                                    <a style="margin-top: 10px;" href="{{route('user.showForum', ['forum'=> $forum, 'course'=>$course, 'material'=> $material])}}" target="_blank"
                                                        rel="noopener noreferrer" data-toggle="tooltip" title="Click to view Forum">{{$forum->title}}
                                                    </a>
                                                </div>
                                                <span style="margin-top: 5px;margin-bottom: 5px;border-bottom: 1px solid #ccc;">
                                                    <h6 class="d-flex align-items-center"
                                                ...
                                                <div class="card">
                                                    <div class="card-body d-flex"
                                                        ...
                                                        <div class="mt-auto"
                                                            ...
                                                            @if ($file->file_extension === 'pdf' || $file->file_extension === 'jpeg'||
                                                            $file->file_extension === 'png'|| $file->file_extension === 'jpg')
                                                            <a style="margin-top: 10px; flex:1" href="{{route('user.showFile', $file)}}"
                                                                target="_blank" rel="noopener noreferrer">{{$file->file_title}}</a>
                                                            @else
                                                            <a style="margin-top: 10px; flex:1"
                                                                href="{{route('user.downloadFiles', $file)}}">{{$file->file_title}}</a>
                                                            @endif
                                                            <a style="margin-right: 5px; margin-top: 15px; flex:0" class="float-right"
                                                                href="{{route('user.downloadFiles', $file)}}"><i
                                                ...
                                                <div class="card">
                                                    <div class="card-body d-flex"
                                                        ...
                                                        <div class="mt-auto"
                                                            ...
                                                            <a style="margin-top: 10px;" href="{{$video->video_url}}" target="_blank"
                                                                rel="noopener noreferrer">{{$video->video_name}}
                                                            </a>
                                                        </div>
                                                        <span style="margin-top: 5px;margin-bottom: 5px;border-bottom: 1px solid #ccc;">
                                                            <h6 class="d-flex align-items-center"
                                            ...
                                            <div class="container" id="fourms">
                                                <div class="card">
                                                    <div class="card-body d-flex"
                                                        style="flex-direction: column; justify-content: space-between">
                                                        @if(count($forums)>0)
                                                        <strong style="margin-bottom: 5px; margin-right: 5px; color: #3b4ec6"># Fourms of
                                                            Discussion</strong>
                                                        @foreach ($forums as $forum)
                                                        <div class="mt-auto"
                                                            style="display: flex; gap: 15px; padding-bottom: 5px; flex-wrap: wrap">
