                ...
                <div class="col-sm-8 mb-3" style="max-width: none">
                    <div class="card h-100" style="border-radius:20px;">
                        <div class="card-body">
                            ...
                            <div class="progress mb-3" style="height: 5px" data-placement='left' data-toggle="tooltip"
                                title="Progress {{$course->pivot->progress}}%">
                            ...
                            <div class="progress mb-3" style="height: 5px" data-placement='left' data-toggle="tooltip"
                                title="Score {{$course->pivot->score}}%">
                                <div class="progress-bar bg-success" role="progressbar"
                                    style="width: {{$course->pivot->score}}%" aria-valuenow="{{$course->pivot->score}}"
