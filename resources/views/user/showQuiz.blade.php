                                        ...
                                        @else
                                            ...
                                            <form action="{{route('user.doQuiz', $quiz)}}" method="POST">
                                                ...
                                                <div style="border-bottom: 1px solid #ccc; padding: 20px">
                                                    ...
                                                    <input type="checkbox" id="option_one{{$question->ID_question}}" name="answer{{$question->ID_question}}"
                                                        value="{{$question->option_one}}">
                                                    <label for="option_one{{$question->ID_question}}"> {{$question->option_one}}</label><br>
                                            
                                                    <input type="checkbox" id="option_two{{$question->ID_question}}" name="answer{{$question->ID_question}}"
                                                        value="{{$question->option_two}}">
                                                    <label for="option_two{{$question->ID_question}}"> {{$question->option_two}}</label><br>
                                            
                                                    <input type="checkbox" id="option_three{{$question->ID_question}}" name="answer{{$question->ID_question}}"
                                                        value="{{$question->option_three}}">
                                                    <label for="option_three{{$question->ID_question}}"> {{$question->option_three}}</label><br>
                                            
                                                    <input type="checkbox" id="option_four{{$question->ID_question}}" name="answer{{$question->ID_question}}"
                                                        value="{{$question->option_four}}">
                                                    <label for="option_four{{$question->ID_question}}"> {{$question->option_four}}</label><br>
                                                </div>
                                                @endforeach
