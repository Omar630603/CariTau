                    ...
                    <table class="table custom-table">
                        ...
                        <tbody>
                            ...
                            <tr scope="row">
                                ...
                                <td><a data-toggle="tooltip" title="Student, click to view"
                                        href="{{ route('admin.userDetails', ['user'=>$transaction->ID_user]) }}">{{$transaction->ID_user}}</a>
                                </td>
                                <td><a data-toggle="tooltip" title="Course, click to view"
                                        href="{{ route('admin.courseDetails', ['course'=>$transaction->ID_course]) }}">{{$transaction->ID_course}}</a>
                                </td>
                                <td>
                                ...
                                <td><a data-toggle="tooltip" title="Proof, click to view" target="_blank"
                                        rel="noopener noreferrer"
                                        href="{{ asset('storage/'.$transaction->proof) }}">IMG#{{$no}}</a></td>
                                ...
                                <td style="display: flex; gap: 5px; justify-content: space-between">
                                    @if ($transaction->approve == 0)
                                    <a data-toggle="modal"
                                        data-target="#ApproveTransaction{{$transaction->ID_transaction}}"
                                        class="btn btn-sm btn-outline-success" style="width: 100%">Approve</a>
                                    <a data-toggle="modal"
                                        data-target="#DisapproveTransaction{{$transaction->ID_transaction}}"
                                        class="btn btn-sm btn-warning" style="width: 100%">Disapprove</a>
                                    @elseif($transaction->approve == 1)
                                    <a data-toggle="modal"
                                        data-target="#PendingTransaction{{$transaction->ID_transaction}}"
                                ...
                                <div class="modal fade" id="ApproveTransaction{{$transaction->ID_transaction}}"
                                    data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog"
                                    aria-labelledby="ApproveTransaction{{$transaction->ID_transaction}}"
                                    aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLongTitle">Approve Transaction
                                                    #{{$no}} - transaction
                                                </h5>
                                            ...
                                            <div class="modal-body">
                                                <div style="margin: 0 20px">
                                                    <form method="post" action="{{ route('admin.approve')}}"
                                                        ...
                                                        @csrf
                                                        <div class="row">
                                                            <div style="width: 100%" class="alert-info p-2 mb-2"
                                                                for="emailing">
                                                                <input type="checkbox" name="emailing"
                                                                    onchange="$('#emailTextApp{{$transaction->ID_transaction}}').toggle('fast');$('#statusApp{{$transaction->ID_transaction}}').prop('checked', true);">
                                                                Notify Student to Their Email About The Approval<br>
                                                                <small>Student Won't be Notified, If You Don't Check the
                                                                    Box</small>
                                                            </div>
                                                            <textarea class="form-control mb-2" name="emailText"
                                                                id="emailTextApp{{$transaction->ID_transaction}}"
                                                                style="display: none" name="emailText" cols="30"
                                                                rows="5"
                                                                placeholder="Write a message to student *Optional"></textarea>
                                                        </div>
                                                        <div class="row">
                                                            <div style="width: 100%" class="alert-info p-2 mb-2"
                                                                for="statusApp{{$transaction->ID_transaction}}">
                                                                <input checked type="checkbox" name="status"
                                                                    id="statusApp{{$transaction->ID_transaction}}">
                                                                Change Course to Full Access for the Student<br>
                                                                <small>Student Won't Get Full Access, If You Don't Check
                                                                    the Box</small>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div style="width: 100%" class="alert-info p-2 mb-2"
                                                                ...
                                                                <small>Transaction Won't be Added to The Bank Balance,
                                                                    If You Don't Check the Box</small>
                                                            </div>
                                                        </div>
                                                        <input hidden type="text" name="ID_bank"
                                                            value="{{$transaction->ID_bank}}">
                                                        <input hidden type="text" name="ID_user"
                                                            value="{{$transaction->ID_user}}">
                                                        <input hidden type="text" name="ID_course"
                                                            value="{{$transaction->ID_course}}">
                                                        <input hidden type="text" name="ID_transaction"
                                                            value="{{$transaction->ID_transaction}}">
                                                        <button style="display: none" type="submit"
                                                            id="js-transactionApprove-submit{{$transaction->ID_transaction}}">Done</button>
                                                    </form>
                                                </div>
                                            </div>
                                ...
                                <div class="modal fade" id="DisapproveTransaction{{$transaction->ID_transaction}}"
                                    data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog"
                                    aria-labelledby="DisapproveTransaction{{$transaction->ID_transaction}}"
                                    aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLongTitle">Disapprove
                                            ...
                                            <div class="modal-body">
                                                <div style="margin: 0 20px">
                                                    <form method="post" action="{{ route('admin.disapprove') }}"
                                                        class="card-body" style="padding: 0;">
                                                        @csrf
                                                        <div class="row">
                                                            <div style="width: 100%" class="alert-warning p-2 mb-2"
                                                                for="emailing">
                                                                <input type="checkbox" name="emailing"
                                                            ...
                                                            <textarea class="form-control mb-2" name="emailText"
                                                                id="emailTextDis{{$transaction->ID_transaction}}"
                                                                style="display: none" name="emailText" cols="30"
                                                                rows="5"
                                                                placeholder="Write a message to student *Optional"></textarea>
                                                        </div>
                                                        <div class="row">
                                                            <div style="width: 100%" class="alert-warning p-2 mb-2"
                                                                for="statusDis{{$transaction->ID_transaction}}">
                                                                <input checked type="checkbox" name="status"
                                                                    id="statusDis{{$transaction->ID_transaction}}">
                                                                Change Course to Preview Access for the Student<br>
                                                                <small>Student Won't Get Preview Access, If You Don't
                                                                    Check the Box</small>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div style="width: 100%" class="alert-warning p-2 mb-2"
                                                                ...
                                                                <small>Transaction Won't be Decreased from The Bank
                                                                    Balance, If You Don't Check the Box</small>
                                                            </div>
                                                        </div>
                                                        <input hidden type="text" name="ID_bank"
                                                            value="{{$transaction->ID_bank}}">
                                ...
                                <div class="modal fade" id="PendingTransaction{{$transaction->ID_transaction}}"
                                    data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog"
                                    aria-labelledby="PendingTransaction{{$transaction->ID_transaction}}"
                                    aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLongTitle">Pending Transaction
                                                    #{{$no}} - transaction
                                                </h5>
                                                <button type="button" class="close" data-dismiss="modal"
                                                    aria-label="Close">
                                            ...
                                            <div class="modal-body">
                                                <div style="margin: 0 20px">
                                                    <form method="post" action="{{ route('admin.pending') }}"
                                                        class="card-body" style="padding: 0;">
                                                        @csrf
                                                        <div class="row">
                                                            <div style="width: 100%" class="alert-dark p-2 mb-2"
                                                                for="emailing">
                                                                <input type="checkbox" name="emailing"
                                                            ...
                                                            <textarea class="form-control mb-2" name="emailText"
                                                                id="emailTextPen{{$transaction->ID_transaction}}"
                                                                style="display: none" name="emailText" cols="30"
                                                                rows="5"
                                                                placeholder="Write a message to student *Optional"></textarea>
                                                        </div>
                                                        <div class="row">
                                                            <div style="width: 100%" class="alert-dark p-2 mb-2"
                                                                for="statusPen{{$transaction->ID_transaction}}">
                                                                <input checked type="checkbox" name="status"
                                                                    id="statusPen{{$transaction->ID_transaction}}">
                                                                Change Course to Preview Access for the Student<br>
                                                                <small>Student Won't Get Preview Access, If You Don't
                                                                    Check the Box</small>
                                                            </div>
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-sm btn-secondary"
                                                    ...
                                                    onclick="document.getElementById('js-transactionPending-submit{{$transaction->ID_transaction}}').click();">Pende
                                                    This Transaction
                                                    changes</button>
                                            </div>
                                        </div>
                                ...
                                <form id="deleteTransaction{{$transaction->ID_transaction}}" style="display: none"
                                    action="{{route('admin.deleteTransaction')}}" method="POST">
                                    @csrf
                                    @method('DELETE')
            ...
            <div class="card-body" style="border-radius:20px;">
                ...
                <div class="table-responsive custom-table-responsive">
                    <div class="container m-2">
                        ...
                        <a onclick="$('#AddBank').toggle('slow');" style="width: 100%"
                    ...
                    <div>
                        <div id="AddBank" style="display: none;" class="container float-right mb-3">
                            <form style="padding: 20px; border-bottom: 2px solid #ccc"
                                action="{{route('admin.addBank')}}" method="POST">
                                @csrf
                                ...
                                <input class="form-control" name="balance" type="number" min="0" placeholder="0"
                                    value="0">
                    ...
                    <table class="table custom-table">
                        ...
                        <tbody>
                            ...
                            <tr scope="row">
                                ...
                                <div class="modal fade" id="editBank{{$bank->ID_bank}}" data-backdrop="static"
                                    data-keyboard="false" tabindex="-1" role="dialog"
                                    aria-labelledby="filesVideoModal{{$bank->ID_bank}}" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                            ...
                                            <div class="modal-body">
                                                <div style="margin: 0 20px">
                                                    <form method="post" action="{{ route('admin.editBank', $bank) }}"
                                                        class="card-body" style="padding: 0;">
                                                        @csrf
