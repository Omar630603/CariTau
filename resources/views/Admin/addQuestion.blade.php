...
<div class="container">
    <div class="form group">
        <h3 style="text-transform: capitalize;">This page is to add / edit questions for : {{$quiz->quiz_name}} in
            <a href="{{ route('admin.materialDetails', $material) }}">{{$material->material_name}}</a> material</h3>
    ...
    <div style="display: flex">
        <dir class="form group" style="flex: 2; margin-left:-40px;">
                ...
                <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="card">
                                <form action="{{route('admin.editQuestion' , $question)}}" method="POST">
                                    @csrf
            ...
            <div style="display: none">
                <form action="{{route('admin.deleteQuestion', $question)}}" method="POST">
                    @csrf
                    @method('DELETE')
        ...
        @if (count($questions)<5) <div class="container" style="flex: 1; margin-top: 15px;">
            <div class="row">
                <div class="col-md-12" style="padding-left: 0; padding-right: 0">
                    <div class="card">
                        <form action="{{route('admin.postQuestion' , $quiz)}}" method="POST">
                            @csrf
                            <div class="card-header">
                                <div class="form-group">
                                    <label for="question">Question</label>
